...
starting_values(x::StaticDrillingPayoff{<:AbstractUnconstrainedDrillingRevenue, DrillingCost_constant, ExtensionCost_Constant}) = [-0x1.5abc9b2ad486fp+1, STARTING_log_ogip, STARTING_σ_ψ, -0x1.efb4349a3e38cp+2,                        -0x1.6ce81fc7e1acep-3, 1.0, ]
starting_values(x::StaticDrillingPayoff{<:AbstractUnconstrainedDrillingRevenue, DrillingCost_dgt1,     ExtensionCost_Constant}) = [-0x1.30492070192dp+2,  STARTING_log_ogip, STARTING_σ_ψ, -0x1.a8ca50a153ecbp+2, -0x1.45888b1d8fc67p+2, -0x1.c68737f1a1d98p-3, 1.0, ]
...
function starting_values(x::StaticDrillingPayoff{<:AbstractUnconstrainedDrillingRevenue, C,  ExtensionCost_Constant}) where {C<:AbstractDrillingCost_TimeFE}
    return vcat(-0x1.a1c8146018faap+1, STARTING_log_ogip, STARTING_σ_ψ, starting_values(x.drillingcost), 0x1.de94ce50afacep+0)
end
