...
solve_vf_all!(evs::dcdp_Emax, t::dcdp_tmpvars, p::dcdp_primitives, θ::AbstractVector, roy::Real, geoid::Integer, dograd::Type     ; kwargs...) = solve_vf_all!(evs, t, p, _θt(θ, geoid), _σv(θ), roy, dograd; kwargs...)
solve_vf_all!(evs::dcdp_Emax, t::dcdp_tmpvars, p::dcdp_primitives, θ::AbstractVector, roy::Real, geoid::Integer, dograd::Bool=true; kwargs...) = solve_vf_all!(evs, t, p, _θt(θ, geoid), _σv(θ), roy, Val{dograd}; kwargs...)
