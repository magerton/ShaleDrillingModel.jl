...
let p0 = dcdp_primitives(:exproy,   β, wp, zspace, Πp1, ψspace),
    ...
    σ = 0.5,
    v0 = [1.0, -0x1.2d34868c62f72p+0, 1.0,             0x1.2b663d526e945p-6,  0x1.e541149a44256p-1,-0x1.a46b48dd5571bp+1,-0x1.55350321e88e3p+0, 0x1.1ec8d5020b7eep+1],
    ...
    @test check_flowgrad(v0, σ, p0, 0.2, 1)
