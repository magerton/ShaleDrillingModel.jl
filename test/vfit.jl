# let
    ...
    anticipate_e = true
        ...
        # @testset "Check vfit/pfit for infinite horizon, anticipate_e = $antipate_e" begin
            ...
            fillflows!(ubV, flow, p, θt, σ, i, itype...)
            ubV .+= β .* EV1
            converged, iter, bnds = ShaleDrillingModel.solve_inf_vfit_pfit!(EV0, tmpv_vw, p; vftol=1e-10, maxit0=20, maxit1=80)
